...
export class ContextExpander {
    windowSize; // Number of sentences before/after (±N)
     ...
     */
    getSentenceStartPosition(sentences, sentenceIndex, documentContent) {
        let pos = 0;
     ...
     */
    getSentenceEndPosition(sentences, sentenceIndex, documentContent) {
        let pos = 0;
        for (let i = 0; i <= sentenceIndex; i++) {
            pos += sentences[i].length;
            // Skip whitespace
