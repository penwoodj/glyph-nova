...
```bash
$ /home/jon/code/llm-ui/.cursor/docs/test-duckduckgo-node.sh
...
3. Select: `/home/jon/code/llm-ui/.cursor/docs/My workflow improved.json`
4. Click **Import**
...
- `/home/jon/code/llm-ui/.cursor/docs/My workflow improved.json` - Fixed workflow
- `/home/jon/code/llm-ui/.cursor/docs/duckduckgo-node-fix.md` - Detailed fix documentation
- `/home/jon/code/llm-ui/.cursor/docs/test-duckduckgo-node.sh` - Test script
- `/home/jon/code/llm-ui/.cursor/docs/duckduckgo-fix-complete.md` - This summary
